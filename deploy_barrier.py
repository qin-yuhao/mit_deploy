...
#     FL_hip        -0.6283      -0.6383       1    -0.0100   (验证:-0.6283)
# FL_thigh      -1.0647      -2.5426       1    -1.4779   (验证:-1.0647)
# FL_calf        2.7227      -0.1178       1    -2.8405   (验证: 2.7227)
# FR_hip        -0.6283       0.7445      -1     0.1162   (验证:-0.6283)
# FR_thigh      -1.0647       2.4642      -1     1.3995   (验证:-1.0647)
# FR_calf        2.7227      -1.9332      -1     0.7895   (验证: 2.7227)
# RL_hip        -0.6283       0.6196      -1    -0.0087   (验证:-0.6283)
# RL_thigh       1.0647       0.5824      -1     1.6471   (验证: 1.0647)
# RL_calf       -2.7053      -0.1161      -1    -2.8214   (验证:-2.7053)
# RR_hip        -0.6283      -0.6801       1    -0.0518   (验证:-0.6283)
# RR_thigh       1.0647      -0.6638       1    -1.7285   (验证: 1.0647)
# RR_calf       -2.7053       0.1638       1     2.8691   (验证:-2.7053)